...
{
    internal sealed class CreateProductCommandValidator : GenericValidator<CreateProductCommand>
    {
        #region Constructors
        ...
        public bool BeUniqueWarehouses(IEnumerable<CreateProductWarehouseCommand> warehouses)
